...
void Main()
{
	...
	new[]
	{
		"Если волк и коза располагается на одном конце бревна, а заяц располагается на другом конце бревна, то история завершается успехом с темой апперцепция",
		"Если волк и коза находятся на одном береге реки, а фермер находится на другом береге реки, то миссия заканчивается неудачей с формулировкой апперцепция"
	}
