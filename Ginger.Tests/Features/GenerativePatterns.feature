...
Scenario: Демонстрация того, как из обобщенного паттерна с одним реплицируемым словом генерируется набор конкретных паттернов
    ...
    |---------------------------------------------------|------------------------------------------------------------------------|
# Обобщенный паттерн может содержать так же и disambiguating annotations
